                        ...
                        if len(face_patches) > 0:
                            ...
                            for bb, landmark, matching_id, dist in zip(
                                ...
                                if chk == 1 :                                    
                                    ...
                                    face_center_x = bb[0] + int((bb[3]-bb[1])/2)
                                    face_center_y = bb[1] + int((bb[2]-bb[0])/2)
